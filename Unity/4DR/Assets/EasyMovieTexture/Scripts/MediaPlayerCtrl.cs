...
public class MediaPlayerCtrl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (m_bFirst == false)
        {
			...
			strName = "https://4dreplaykorea.sharepoint.com/:v:/s/4DReplay/EYSjW7KYCTpLs63HkNTViJcBjYbXMn-4YbTWPZ8XNORDcA?e=ADWMoA";
#endif
	...
	private unsafe bool Call_Load(string strFileName, int iSeek)
	{
		...
		if (ffmpeg.avformat_open_input(&ppFomatContext, strFileName, null, null) != 0)
		{
			...
			Debug.Log("MEDIAPLAYER_STATE.ERROR : Could not open file : " + strFileName);
